    ...
    config = function()
        ...
        vim.api.nvim_create_autocmd('LspAttach', {
            callback = function(event)
                ...
                -- Alternative: Use Telescope for references (more modern UI)
                vim.keymap.set('n', '<leader>gr', '<cmd>lua require("telescope.builtin").lsp_references()<cr>', { buffer = event.buf, desc = "References (Telescope)" })
